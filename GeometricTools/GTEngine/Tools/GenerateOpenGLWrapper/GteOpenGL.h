...
// Define GLAPI for use by glcorearb.h.
#if defined(OPENGL4_EXPORT)
// For the dynamic library configurations.
#define GLAPI extern __declspec(dllexport)
#elif defined(OPENGL4_IMPORT)
// For a client of the dynamic library.
#define GLAPI extern __declspec(dllimport)
#else
// For the static library configurations.
#define GLAPI
#endif
