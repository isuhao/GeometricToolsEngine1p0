...
int main(int, char const*[])
{
    ...
    parameters.title = L"MultipleRenderTargetsWindow";
    parameters.xOrigin = 0;
    parameters.yOrigin = 0;
    parameters.xSize = 512;
    parameters.ySize = 256;
    parameters.allowResize = true;
    parameters.deviceCreationFlags = D3D11_CREATE_DEVICE_DEBUG;

    MultipleRenderTargetsWindow* window =
        TheWindowSystem.Create<MultipleRenderTargetsWindow>(parameters);
