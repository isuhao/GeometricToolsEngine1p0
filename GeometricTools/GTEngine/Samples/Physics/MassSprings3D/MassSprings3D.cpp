...
int main(int, char const*[])
{
    ...
    parameters.title = L"MassSprings3DWindow";
    ...
    MassSprings3DWindow* window =
        TheWindowSystem.Create<MassSprings3DWindow>(parameters);
    ...
    if (window)
    {
        ...
        TheWindowSystem.Destroy<MassSprings3DWindow>(window);
    }
