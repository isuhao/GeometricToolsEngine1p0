...
int main(int, char const*[])
{
    ...
    parameters.title = L"Fluids2DWindow";
    ...
    parameters.xSize = Fluids2DWindow::GRID_SIZE;
    parameters.ySize = Fluids2DWindow::GRID_SIZE;
#else
    parameters.xSize = 1024;
    parameters.ySize = 1024;
#endif

    Fluids2DWindow* window =
        TheWindowSystem.Create<Fluids2DWindow>(parameters);
