...
class SurfaceExtractionWindow : public Window
{
public:
    virtual ~SurfaceExtractionWindow();
...
private:
    ...
    std::shared_ptr<ComputeShader> mDirectExtractShader;
    ...
    std::shared_ptr<ComputeShader> mIndirectExtractShader;
