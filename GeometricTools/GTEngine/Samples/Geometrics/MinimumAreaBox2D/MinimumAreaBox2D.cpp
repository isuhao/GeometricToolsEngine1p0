...
int main(int, char const*[])
{
    ...
    parameters.title = L"MinimumAreaBox2DWindow";
    ...
    MinimumAreaBox2DWindow* window =
        TheWindowSystem.Create<MinimumAreaBox2DWindow>(parameters);
    ...
    if (window)
    {
        ...
        TheWindowSystem.Destroy<MinimumAreaBox2DWindow>(window);
    }
