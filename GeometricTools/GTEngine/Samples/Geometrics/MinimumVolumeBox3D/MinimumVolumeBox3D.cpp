...
int main(int, char const*[])
{
    ...
    parameters.title = L"MinimumVolumeBox3DWindow";
    ...
    MinimumVolumeBox3DWindow* window =
        TheWindowSystem.Create<MinimumVolumeBox3DWindow>(parameters);
    ...
    if (window)
    {
        ...
        TheWindowSystem.Destroy<MinimumVolumeBox3DWindow>(window);
    }
