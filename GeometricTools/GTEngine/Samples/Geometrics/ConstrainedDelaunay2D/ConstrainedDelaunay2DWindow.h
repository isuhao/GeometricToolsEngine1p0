...
{
public:
    virtual ~ConstrainedDelaunay2DWindow();
...
private:
    ...
    ConstrainedDelaunay2<float, BSNumber<BSUInteger<5>>> mDelaunay;
    ConstrainedDelaunay2<float, BSNumber<BSUInteger<5>>>::SearchInfo mInfo;
};
