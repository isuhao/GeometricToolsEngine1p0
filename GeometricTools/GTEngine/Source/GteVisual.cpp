...
{
    if (!mVBuffer || !mIBuffer)
    {
        LogError("Buffers not attached.");
        return false;
    }
...
//----------------------------------------------------------------------------
void Visual::SetName (std::string const& name)
{
    mName = name;
    ...
    if (mEffect)
    {
        mEffect->SetName(mName + ":mEffect");
    }
}
//----------------------------------------------------------------------------
std::string const& Visual::GetName () const
{
    return mName;
}
//----------------------------------------------------------------------------
