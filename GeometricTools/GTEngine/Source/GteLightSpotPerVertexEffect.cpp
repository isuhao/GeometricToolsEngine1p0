...
//----------------------------------------------------------------------------
LightSpotPerVertexEffect::LightSpotPerVertexEffect(Lighting const& lighting)
{
...
//----------------------------------------------------------------------------
void LightSpotPerVertexEffect::SetName(std::string const& name)
{
...
std::string const LightSpotPerVertexEffect::msHLSLString =
