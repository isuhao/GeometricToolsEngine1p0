...
//----------------------------------------------------------------------------
DX11Texture1Array::~DX11Texture1Array()
{
}
//----------------------------------------------------------------------------
DX11Texture1Array::DX11Texture1Array(ID3D11Device* device,
    ...
    DX11TextureArray(textureArray)
{
    ...
    if (textureArray->GetData())
    {
        unsigned int const numSubresources =
            textureArray->GetNumSubresources();
...
//----------------------------------------------------------------------------
DX11GraphicsObject* DX11Texture1Array::Create(ID3D11Device* device,
    GraphicsObject const* object)
{
    if (object->GetType() == GT_TEXTURE1_ARRAY)
    {
        return new DX11Texture1Array(device,
...
//----------------------------------------------------------------------------
Texture1Array* DX11Texture1Array::GetTextureArray() const
{
    return static_cast<Texture1Array*>(mGTObject);
}
//----------------------------------------------------------------------------
ID3D11Texture1D* DX11Texture1Array::GetDXTextureArray() const
{
    return static_cast<ID3D11Texture1D*>(mDXObject);
}
//----------------------------------------------------------------------------
void DX11Texture1Array::CreateStaging(ID3D11Device* device,
    D3D11_TEXTURE1D_DESC const& tx)
{
    D3D11_TEXTURE1D_DESC desc;
    desc.Width = tx.Width;
...
//----------------------------------------------------------------------------
void DX11Texture1Array::CreateSRView(ID3D11Device* device,
    D3D11_TEXTURE1D_DESC const& tx)
{
...
//----------------------------------------------------------------------------
void DX11Texture1Array::CreateUAView(ID3D11Device* device,
    D3D11_TEXTURE1D_DESC const& tx)
{
