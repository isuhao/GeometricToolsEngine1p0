...
//----------------------------------------------------------------------------
DX11GraphicsObject* DX11StructuredBuffer::Create(ID3D11Device* device,
    GraphicsObject const* object)
{
    if (object->GetType() == GT_STRUCTURED_BUFFER)
    {
        return new DX11StructuredBuffer(device,
...
//----------------------------------------------------------------------------
StructuredBuffer* DX11StructuredBuffer::GetStructuredBuffer() const
{
    return static_cast<StructuredBuffer*>(mGTObject);
}
//----------------------------------------------------------------------------
ID3D11ShaderResourceView* DX11StructuredBuffer::GetSRView() const
{
    return mSRView;
}
//----------------------------------------------------------------------------
ID3D11UnorderedAccessView* DX11StructuredBuffer::GetUAView() const
{
    return mUAView;
}
//----------------------------------------------------------------------------
ID3D11Buffer* DX11StructuredBuffer::GetCounterStagingBuffer() const
{
    ...
    ID3D11DeviceContext* context)
{
    ...
    ID3D11Buffer* buffer = static_cast<ID3D11Buffer*>(mCounterStaging);
    context->CopyStructureCount(buffer, 0, mUAView);
