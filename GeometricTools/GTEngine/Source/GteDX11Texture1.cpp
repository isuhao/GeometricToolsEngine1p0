...
//----------------------------------------------------------------------------
DX11GraphicsObject* DX11Texture1::Create(ID3D11Device* device,
    GraphicsObject const* object)
{
    if (object->GetType() == GT_TEXTURE1)
    {
        return new DX11Texture1(device, static_cast<Texture1 const*>(object));
    }
...
//----------------------------------------------------------------------------
Texture1* DX11Texture1::GetTexture() const
{
    return static_cast<Texture1*>(mGTObject);
}
//----------------------------------------------------------------------------
ID3D11Texture1D* DX11Texture1::GetDXTexture() const
{
    return static_cast<ID3D11Texture1D*>(mDXObject);
}
//----------------------------------------------------------------------------
void DX11Texture1::CreateStaging(ID3D11Device* device,
...
//----------------------------------------------------------------------------
void DX11Texture1::CreateSRView(ID3D11Device* device,
    D3D11_TEXTURE1D_DESC const& tx)
{
...
//----------------------------------------------------------------------------
void DX11Texture1::CreateUAView(ID3D11Device* device,
    D3D11_TEXTURE1D_DESC const& tx)
{
