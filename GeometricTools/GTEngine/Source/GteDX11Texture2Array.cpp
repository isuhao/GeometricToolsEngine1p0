...
//----------------------------------------------------------------------------
DX11Texture2Array::~DX11Texture2Array()
{
}
//----------------------------------------------------------------------------
DX11Texture2Array::DX11Texture2Array(ID3D11Device* device,
...
//----------------------------------------------------------------------------
DX11GraphicsObject* DX11Texture2Array::Create(ID3D11Device* device,
    GraphicsObject const* object)
{
    if (object->GetType() == GT_TEXTURE2_ARRAY)
    {
        return new DX11Texture2Array(device,
...
//----------------------------------------------------------------------------
Texture2Array* DX11Texture2Array::GetTextureArray() const
{
    return static_cast<Texture2Array*>(mGTObject);
}
//----------------------------------------------------------------------------
ID3D11Texture2D* DX11Texture2Array::GetDXTextureArray() const
{
    return static_cast<ID3D11Texture2D*>(mDXObject);
}
//----------------------------------------------------------------------------
void DX11Texture2Array::CreateStaging(ID3D11Device* device,
...
//----------------------------------------------------------------------------
void DX11Texture2Array::CreateSRView(ID3D11Device* device,
    D3D11_TEXTURE2D_DESC const& tx)
{
...
//----------------------------------------------------------------------------
void DX11Texture2Array::CreateUAView(ID3D11Device* device,
    D3D11_TEXTURE2D_DESC const& tx)
{
