...
template <int D>
inline Real InvSqrtEstimate<Real>::Degree(Real x)
{
...
template <typename Real>
template <int D>
inline Real InvSqrtEstimate<Real>::DegreeRR(Real x)
{
    Real adj, y;
    int p;
    Reduce(x, adj, y, p);
...
//----------------------------------------------------------------------------
template <typename Real>
inline Real InvSqrtEstimate<Real>::Evaluate(degree<1>, Real t)
{
    Real poly;
...
//----------------------------------------------------------------------------
template <typename Real>
inline Real InvSqrtEstimate<Real>::Evaluate(degree<2>, Real t)
{
    Real poly;
...
//----------------------------------------------------------------------------
template <typename Real>
inline Real InvSqrtEstimate<Real>::Evaluate(degree<3>, Real t)
{
    Real poly;
...
//----------------------------------------------------------------------------
template <typename Real>
inline Real InvSqrtEstimate<Real>::Evaluate(degree<4>, Real t)
{
    Real poly;
...
//----------------------------------------------------------------------------
template <typename Real>
inline Real InvSqrtEstimate<Real>::Evaluate(degree<5>, Real t)
{
    Real poly;
...
//----------------------------------------------------------------------------
template <typename Real>
inline Real InvSqrtEstimate<Real>::Evaluate(degree<6>, Real t)
{
    Real poly;
...
//----------------------------------------------------------------------------
template <typename Real>
inline Real InvSqrtEstimate<Real>::Evaluate(degree<7>, Real t)
{
    Real poly;
...
//----------------------------------------------------------------------------
template <typename Real>
inline Real InvSqrtEstimate<Real>::Evaluate(degree<8>, Real t)
{
    Real poly;
...
//----------------------------------------------------------------------------
template <typename Real>
inline void InvSqrtEstimate<Real>::Reduce(Real x, Real& adj, Real& y, int& p)
{
...
//----------------------------------------------------------------------------
template <typename Real>
inline Real InvSqrtEstimate<Real>::Combine(Real adj, Real y, int p)
{
