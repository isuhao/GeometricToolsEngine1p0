...
typename DCPQuery<Real, Rectangle3<Real>, Rectangle3<Real>>::Result
DCPQuery<Real, Rectangle3<Real>, Rectangle3<Real>>::operator()(
    Rectangle3<Real> const& rectangle0, Rectangle3<Real> const& rectangle1)
{
    Result result;

    DCPQuery<Real, Segment3<Real>, Rectangle3<Real>> srQuery;
    DCPQuery<Real, Segment3<Real>, Rectangle3<Real>>::Result srResult;
