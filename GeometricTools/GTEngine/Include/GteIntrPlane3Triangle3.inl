...
typename TIQuery<Real, Plane3<Real>, Triangle3<Real>>::Result
TIQuery<Real, Plane3<Real>, Triangle3<Real>>::operator()(
    Plane3<Real> const& plane, Triangle3<Real> const& triangle)
{
    Result result;
...
//----------------------------------------------------------------------------
template <typename Real>
typename FIQuery<Real, Plane3<Real>, Triangle3<Real>>::Result
FIQuery<Real, Plane3<Real>, Triangle3<Real>>::operator()(
    Plane3<Real> const& plane, Triangle3<Real> const& triangle)
{
    Result result;
