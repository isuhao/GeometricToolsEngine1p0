...
class GTE_IMPEXP LightDirectionPerVertexEffect : public VisualEffect
{
public:
    struct Lighting
    {
        ...
        Vector4<float> lightModelDirection; // (x,y,z,0)
    ...
    // Construction.
    LightDirectionPerVertexEffect(Lighting const& lighting);
...
#include "GteLightDirectionPerVertexEffect.inl"
