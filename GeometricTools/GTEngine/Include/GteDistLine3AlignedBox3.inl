...
typename DCPQuery<Real, Line3<Real>, AlignedBox3<Real>>::Result
DCPQuery<Real, Line3<Real>, AlignedBox3<Real>>::operator()(
...
//----------------------------------------------------------------------------
template <typename Real>
void DCPQuery<Real, Line3<Real>, AlignedBox3<Real>>::DoQuery(
    Vector3<Real>& point, Vector3<Real>& direction,
...
//----------------------------------------------------------------------------
template <typename Real>
void DCPQuery<Real, Line3<Real>, AlignedBox3<Real>>::Face(int i0, int i1,
    int i2, Vector3<Real>& pnt, Vector3<Real> const& dir,
    Vector3<Real> const& PmE, Vector3<Real> const& boxExtent, Result& result)
{
    Vector3<Real> PpE;
...
//----------------------------------------------------------------------------
template <typename Real>
void DCPQuery<Real, Line3<Real>, AlignedBox3<Real>>::CaseNoZeros(
    Vector3<Real>& pnt, Vector3<Real> const& dir,
    Vector3<Real> const& boxExtent, Result& result)
{
...
//----------------------------------------------------------------------------
template <typename Real>
void DCPQuery<Real, Line3<Real>, AlignedBox3<Real>>::Case0(int i0, int i1,
    int i2, Vector3<Real>& pnt, Vector3<Real> const& dir,
    Vector3<Real> const& boxExtent, Result& result)
{
...
//----------------------------------------------------------------------------
template <typename Real>
void DCPQuery<Real, Line3<Real>, AlignedBox3<Real>>::Case00(int i0, int i1,
    int i2, Vector3<Real>& pnt, Vector3<Real> const& dir,
    Vector3<Real> const& boxExtent, Result& result)
{
    Real delta;
...
//----------------------------------------------------------------------------
template <typename Real>
void DCPQuery<Real, Line3<Real>, AlignedBox3<Real>>::Case000(
    Vector3<Real>& pnt, Vector3<Real> const& boxExtent, Result& result)
{
    Real delta;
