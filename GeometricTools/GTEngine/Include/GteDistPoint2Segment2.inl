...
typename DCPQuery<Real, Vector2<Real>, Segment2<Real>>::Result
DCPQuery<Real, Vector2<Real>, Segment2<Real>>::operator()(
    Vector2<Real> const& point, Segment2<Real> const& segment)
{
    Result result;

    Vector2<Real> center, direction;
    Real extent;
