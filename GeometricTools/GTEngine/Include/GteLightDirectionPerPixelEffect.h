...
class GTE_IMPEXP LightDirectionPerPixelEffect : public VisualEffect
{
public:
    struct Lighting
    {
    ...
    // Construction.
    LightDirectionPerPixelEffect(Lighting const& lighting);
...
#include "GteLightDirectionPerPixelEffect.inl"
