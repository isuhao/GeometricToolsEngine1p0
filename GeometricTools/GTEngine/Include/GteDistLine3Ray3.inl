...
typename DCPQuery<Real, Line3<Real>, Ray3<Real>>::Result
DCPQuery<Real, Line3<Real>, Ray3<Real>>::operator()(
    Line3<Real> const& line, Ray3<Real> const& ray)
{
    Result result;

    Vector3<Real> diff = line.origin - ray.origin;
