...
class GTE_IMPEXP LightPointPerVertexEffect : public VisualEffect
{
public:
    struct Lighting
    {
    ...
    // Construction.
    LightPointPerVertexEffect(Lighting const& lighting);
...
#include "GteLightPointPerVertexEffect.inl"
