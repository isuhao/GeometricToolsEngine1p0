...
protected:
    ...
    Resource(unsigned int numElements, size_t elementSize,
...
public:
    ...
    // element occupies mNumElements bytes.  Treating the data array as an
