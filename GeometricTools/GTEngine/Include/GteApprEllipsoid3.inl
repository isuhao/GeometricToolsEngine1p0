    ...
    Matrix3x3<Real>& rotate)
{
    ...
    AxisAngle<3, Real> aa;
    aa.axis = Vector3<Real>(cs0*sn1, sn0*sn1, cs1);
    aa.angle = angle[2];
    ...
    Real const* input)
{
    ...
    Ellipsoid3<Real> ellipsoid(Vector3<Real>::Zero(), Vector3<Real>::Basis0(),
        Vector3<Real>::Basis1(), Vector3<Real>::Basis2(), invMax*input[0],
