...
typename DCPQuery<Real, Ray3<Real>, Ray3<Real>>::Result
DCPQuery<Real, Ray3<Real>, Ray3<Real>>::operator()(
    Ray3<Real> const& ray0, Ray3<Real> const& ray1)
{
    Result result;

    Vector3<Real> diff = ray0.origin - ray1.origin;
