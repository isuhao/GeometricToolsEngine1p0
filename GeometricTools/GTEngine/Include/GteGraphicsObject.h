...
public:
    ...
    static void SubscribeForDestruction(ListenerForDestruction* listener);
    static void UnsubscribeForDestruction(ListenerForDestruction* listener);
...
private:
    ...
    static std::set<ListenerForDestruction*> msLFDSet;
};

#include "GteGraphicsObject.inl"
